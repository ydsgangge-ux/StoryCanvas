  ...
  return (
    <div className={`block-node ${selected ? 'selected' : ''}`} style={{ borderColor: color, minWidth: 240 }}>
      <div className="block-header">
        ...
        <div className="block-title">{content.name || '新角色'}</div>
